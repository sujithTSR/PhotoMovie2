    ...
    protected void onFinishInflate() {
        ...
        mAdapter = new RecyclerView.Adapter() {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                ImageView img = viewHolder.itemView.findViewById(R.id.filter_img);
                TextView txt = viewHolder.itemView.findViewById(R.id.filter_txt);
                ImageView checkImg = viewHolder.itemView.findViewById(R.id.filter_check);
                final int position = i;
                final FilterItem item = mItemList.get(i);
                img.setImageResource(item.imgRes);
                txt.setText(item.name);
                checkImg.setVisibility(mCheckIndex==i?View.VISIBLE:View.GONE);
